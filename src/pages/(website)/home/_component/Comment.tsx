...
const Comment = () => {
  ...
  <div className="lg:w-[1440px] mb:w-[342px] mx-auto flex justify-end">
    <strong className="lg:w-[1320px] mb:w-full lg:text-[64px] mb:text-[32px] lg:leading-[70px] mb:leading-[38px] lg:tracking-[-4.7px] mb:tracking-[-1.9px]">CUSTOMER
      TESTIMONIALS</strong>
  </div>
  {/* best comment  */}
  <div className="w-full relative flex sm:flex-row mb:flex-col mb:items-center justify-center lg:my-16 mb:my-8">
    <div className="lg:w-[1440px] mb:w-[342px] flex justify-end -mt-1.5 *:lg:h-[425px] *:sm:h-[350px] overflow-hidden pt-1">
      <div className="grid sm:gap-x-[32px] mb:w-[342px] sm:w-[95vw] mb:gap-y-10 sm:gap-y-0 sm:grid-cols-[379px_auto] mb:flex-col items-center lg:w-[1348px] 
  lg:translate-x-[28px]">
        {/* content and user comment */}
        <div className="sm:w-full mb:w-[342px] text-white rounded-2xl lg:h-full mb:h-[348px] bg-[#05422C] flex flex-col 
    *:h-[46.5%] items-center gap-y-[23px] lg:px-10 lg:pt-[42px] lg:pb-[39px] mb:px-6 mb:pt-6 mb:pb-16 *:w-full mt-[3px]">
          ...
          <div className="w-10 h-4 border-t flex flex-col justify-between pt-6">
            <strong className="text-[30px] font-medium opacity-60">Google</strong>
            ...
            <section className="flex gap-x-6 lg:mt-0 mb:mt-[18px]">
              ...
              <div className="flex gap-x-2">
                <span>on 135</span><span className="opacity-60">Reviews</span>
              </div>
            </section>
          </div>
        </div>
        ...
        <div className="mb:hidden w-full sm:block h-full overflow-x-scroll hidden_scroll_x">
          <div className="grid grid-flow-col auto-cols-[379px] *:w-full h-full gap-x-[32px] h-[425px]">
            {/* item 1 */}
            <div className="flex flex-col justify-between overflow-hidden h-full rounded-xl border lg:p-[40px]">
              ...
              <div className="w-full h-[252px] rounded-xl">
                ...
                <div className="flex items-center gap-[16px]">
                  <img className="w-[36px] h-[36px] bg-gray-200  rounded-[50%] p-1" src="/Images/img_product.png" alt="" />
                ...
                <div className="flex flex-col lg:mt-0.5 h-[152px] gap-y-4">
                  ...
                  <p>Absolutely love TopShelfBC; affordable on any budget and such fast delivery, straight to my door!
                    I recommend them to all my friends and family for their 420 needs.</p>
                </div>
              </div>
              {/* about */}
              <div className="w-full flex flex-col justify-between">
                <strong className="font-light text-left text-[#9D9EA2] text-sm">January 15, 2023</strong>
              </div>
            </div>
            {/* item 1 */}
            <div className="flex flex-col justify-between overflow-hidden h-full rounded-xl border lg:p-[40px]">
              ...
              {/* about */}
              <div className="w-full flex flex-col justify-between">
                <strong className="font-light text-left text-[#9D9EA2] text-sm">January 5, 2023</strong>
              </div>
            </div>
            {/* item 2 */}
            <div className="flex flex-col justify-between overflow-hidden h-full rounded-xl border lg:p-[40px]">
    ...
    {/* comment mobile */}
    <div className="sm:hidden w-full mt-8 h-full custome_scroll_x_center_item_content snap-x gap-x-[24px] h-[568px] overflow-x-auto hidden_scroll_x">
        ...
        <div className="flex snap-center flex-col justify-between overflow-hidden h-full rounded-xl border px-6 py-[22px]">
          ...
          <div className="w-full h-[252px] rounded-xl">
            ...
            <div className="flex flex-col h-[152px] gap-y-4">
              ...
              <p className="text-[16px] leading-[24px]">Absolutely love TopShelfBC; affordable on any budget and such fast
                delivery, straight
                to my door!
                I recommend them to all my friends and family for their 420 needs.</p>
            </div>
    ...
    <div className="absolute flex justify-between lg:w-[52%] mb:w-[80%] -translate-y-1/2 *:duration-300 *:cursor-pointer 
