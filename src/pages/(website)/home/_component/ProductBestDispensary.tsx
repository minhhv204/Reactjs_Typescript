          ...
          <div className="grid grid-flow-col auto-cols-[291px] *:w-full h-full gap-x-[32px] h-[568px]">
            ...
            <div className="flex flex-col justify-between overflow-hidden h-full rounded-xl">
              ...
              <div className="relative group w-full h-[240px] bg-[#F4F4F4] rounded-xl grid place-items-center">
                <img className="w-[164px] h-[164px]" src="/Images/product_5.png" alt="" />
              ...
              <div className="w-full h-[304px] flex flex-col justify-between items-center">
                ...
                <strong className="text-lg line-clamp-2 font-normal text-[#1A1E26] my-1">2 Oz Deal Watermelon Zkittles + Purple
                  Gushers</strong>
            ...
            <div className="flex flex-col justify-between overflow-hidden h-full rounded-xl">
              {/* img */}
              <div className="relative group w-full h-[240px] bg-[#F4F4F4] rounded-xl grid place-items-center">
                <img className="w-[164px] h-[164px]" src="/Images/img_product.png" alt="" />
                <button className="absolute scale-0 group-hover:scale-100 group-hover:translate-y-0 -translate-y-[200%] duration-200 z-[2] lg:w-[152px] mb:w-[136px] lg:h-[64px]  mb:h-[48px] rounded-[100px] border-none bg-[#1A1E2630] text-sm text-white backdrop-blur-md">Out
                  Of Stock</button>
                <section className="hidden absolute top-0 left-0 bg-[#F2BC1B] px-3 py-1.5 text-white">$60 ounce
                </section>
              ...
              {/* about */}
              <div className="w-full h-[304px] flex flex-col justify-between items-center">
                <strong className="uppercase font-light text-center text-[#9D9EA2]">CONCENTRATES</strong>
                <strong className="text-lg line-clamp-2 font-normal text-[#1A1E26] my-1">Mix And Match Shatter/Budder 28g (4 X
                  7G)</strong>
                <section className="w-[163px] h-[21px] *:text-sm flex justify-between items-start">
                  <div className="flex items-start">
                    <svg xmlns="http://www.w3.org/2000/svg" width={16} height={16} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-star">
            ...
            <div className="flex flex-col justify-between overflow-hidden h-full rounded-xl">
              ...
              <div className="relative group w-full h-[240px] bg-[#F4F4F4] rounded-xl grid place-items-center">
                ...
                <button className="absolute scale-0 group-hover:scale-100 group-hover:translate-y-0 -translate-y-[200%] duration-200 z-[2] lg:w-[152px] mb:w-[136px] lg:h-[64px]  mb:h-[48px] rounded-[100px] border-none bg-[#1A1E2630] text-sm text-white backdrop-blur-md">Out
                  Of Stock</button>
                <section className="absolute top-0 left-0 bg-[#F2BC1B] px-3 py-1.5 text-white">$60 ounce</section>
              </div>
              {/* about */}
              <div className="w-full h-[304px] flex flex-col justify-between items-center">
                <strong className="uppercase font-light text-center text-[#9D9EA2]">flower</strong>
                <strong className="text-lg line-clamp-2 font-normal text-[#1A1E26] my-1">2 Oz Deal Ahi Tuna + Master <br />
                  Tuna</strong>
                <section className="w-[163px] h-[21px] *:text-sm flex justify-between items-start">
                  <div className="flex items-start">
                    <svg xmlns="http://www.w3.org/2000/svg" width={16} height={16} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-star">
            ...
            <div className="flex flex-col justify-between overflow-hidden h-full rounded-xl">
              ...
              <div className="w-full h-[304px] flex flex-col justify-between items-center">
                <strong className="uppercase font-light text-center text-[#9D9EA2]">flower</strong>
                <strong className="text-lg font-normal line-clamp-2 text-[#1A1E26] my-1">2 Oz Deal Watermelon Zkittles + Purple
                  Gushers</strong>
                <section className="w-[163px] h-[21px] *:text-sm flex justify-between items-start">
                  <div className="flex items-start">
                    <svg xmlns="http://www.w3.org/2000/svg" width={16} height={16} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-star">
...
export default ProductBestDispensary